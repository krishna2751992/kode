...
To optimize the desyappsvc application for production, run:
...
```
$ docker image tag desyappsvc desycontainer.azurecr.us/desyappsvc
$ docker push desycontainer.azurecr.us/desyappsvc
```
